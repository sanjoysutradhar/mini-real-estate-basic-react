import footer01 from "../../images/blog/blog-footer-01.jpg";
import footer02 from "../../images/blog/blog-footer-02.jpg";
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              >
                <img src={footerLogo} alt="logo" class="max-w-full" />
              </a>
          ...
          {footer_Columns.map((col) => (
            <FooterColumn key={col.id} name={col.name} list={col.list} />
          ))}
